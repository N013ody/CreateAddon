package io.github.n013ody.createaddon;

import com.mojang.logging.LogUtils;
import io.github.n013ody.createaddon.content.guidance.threshold.ThresholdControllerManager;
import io.github.n013ody.createaddon.registry.ModBlockEntities;
import io.github.n013ody.createaddon.registry.ModBlocks;
import io.github.n013ody.createaddon.registry.ModCreativeTabs;
...
public class CreateAddon {
    ...
    public CreateAddon(IEventBus modEventBus) {
        ...
        if (FMLEnvironment.dist == Dist.CLIENT)
            io.github.n013ody.createaddon.client.CreateAddonClient.register(modEventBus);
